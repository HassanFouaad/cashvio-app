...
### Store Management
Learn how to **create and configure your stores**, set up **payment methods**, **fulfillment methods**, **service fees**, **delivery zones**, and **receipt settings**.

### Product Catalogue
Manage your **categories**, **product options** (like sizes and colors), and **products with variants**.

### Sales & Orders
Learn how to **create orders**, **manage existing orders**, track **overdue payments**, and handle day-to-day sales operations.
...
### Online Store
Set up your **online storefront** so customers can browse products, add items to cart, and **place orders online**.
