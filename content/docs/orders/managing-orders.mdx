...
<Callout title="Note">
Only **Pending** orders can be cancelled. Cancelling reverses inventory changes if inventory tracking was enabled — stock levels return to what they were before the order.
</Callout>
