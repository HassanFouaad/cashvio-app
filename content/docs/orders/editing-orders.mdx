...
You can edit a **pending** POS order while it is still unpaid and not completed. Open **Sales > Orders**, open the order, then use **Edit** in the **Order Items** section, or **Attach customer**, when those actions appear.
...
1. Open the order and click **Edit** at the top of the **Order Items** section.
