...
export function GET() {
  ...
  const lines: string[] = [
    ...
    '',
    `Cashvio is a complete business management platform for online and in-store operations. It provides product catalogue management, inventory control, multi-channel order processing, customer management, supplier & purchasing, analytics & reporting, team roles & permissions, and online storefront capabilities. It is fully bilingual (English and Arabic with native RTL) and offers a free forever plan with no credit card required.`,
    '',
    `## Product`,
    '',
