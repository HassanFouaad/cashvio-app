...
export const alt = 'Cashvio - AI Assistant for Retail Store Management';
export const size = {
  width: 1200,
  height: 630,
};
...
export default async function OGImage({
  ...
  const features = isArabic
    ? [
        ...
        'استعلامات المخزون الحية',
        'بطاقات موافقة آمنة',
        'ملخصات الأرباح والمبيعات',
        'كشف البضاعة الراكدة',
        'حد يومي واضح للاستخدام',
      ]
    : [
        'Natural Arabic & English',
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          cash-vio.com/features/ai-assistant
        </div>
      </div>
    ),
    { ...size, ...(fonts ? { fonts } : {}) }
