...
export const alt = 'Cashvio - Free Online Store';
export const size = {
  width: 1200,
  height: 630,
};
...
export default async function OGImage({
  ...
  const features = isArabic
    ? ['بدون عمولة', 'عربي وإنجليزي', 'مناطق توصيل', 'كوبونات', 'متزامن مع الكاشير', 'مجاني للأبد']
    : ['No Commission', 'Arabic & English', 'Delivery Zones', 'Coupons', 'Synced with POS', 'Free Forever'];
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          cash-vio.com/features/free-online-store
        </div>
      </div>
    ),
    { ...size, ...(fonts ? { fonts } : {}) }
