...
export const mainNavigation: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { key: 'industryBookstore', href: '/industries/bookstore' },
      { key: 'industryGiftShop', href: '/industries/gift-shop' },
      { key: 'industryJewelry', href: '/industries/jewelry' },
      { key: 'industryHardware', href: '/industries/hardware' },
      { key: 'industryElectronics', href: '/industries/electronics' },
      { key: 'industryStationery', href: '/industries/stationery' },
      { key: 'industryAutoParts', href: '/industries/auto-parts' },
      { key: 'industryFurniture', href: '/industries/furniture' },
      { key: 'industryOptics', href: '/industries/optics' },
    ],
  },
...
export const footerNavigation: FooterSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'freeOnlineStore', href: '/features/free-online-store' },
      { key: 'freeOnlineStoreEgypt', href: '/free-online-store-egypt' },
      { key: 'arabicPos', href: '/features/arabic-pos' },
      { key: 'omnichannelRetail', href: '/features/omnichannel-retail' },
      { key: 'inventoryManagement', href: '/features/inventory-management' },
      { key: 'couponsAndDiscounts', href: '/features/coupons-and-discounts' },
