 ...
 */
export const contentLastUpdated = '2026-08-28';
...
export const social = {
  x: {
    handle: '@cashvio',
    url: env.social.x || 'https://x.com/cashvio',
  },
  facebook: {
    url: env.social.facebook || 'https://www.facebook.com/cashvio',
    appId: env.social.facebookAppId,
  },
  linkedin: {
...
// ============================================================================
// X CARD DEFAULTS (Next.js Metadata API still uses the `twitter` key)
// ============================================================================

export const xCardDefaults = {
  card: 'summary_large_image' as const,
  site: social.x.handle,
  creator: social.x.handle,
  // Note: Card images are auto-generated by twitter-image.tsx (Next.js file convention)
