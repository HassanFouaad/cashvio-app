      ...
      <div className="container-wide">
        <div className="relative overflow-hidden rounded-2xl md:rounded-3xl bg-gradient-primary p-6 sm:p-8 md:p-12 lg:p-16 text-center">
          ...
          <div className="relative z-10 max-w-2xl mx-auto">
            {/* Free Forever Badge */}
            <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full bg-white/15 backdrop-blur-sm text-primary-foreground text-xs sm:text-sm font-medium mb-4 sm:mb-6 border border-white/20">
            ...
            <p className="text-base sm:text-lg md:text-xl text-primary-foreground/90 mb-6 sm:mb-8 max-w-xl mx-auto">
              {t('subtitle')}
            </p>
            
            <ButtonLink
              size="xl"
              className="bg-background text-primary hover:bg-background/90 shadow-lg hover:shadow-xl transition-all duration-300 text-sm sm:text-base"
            ...
            <div className="mt-5 sm:mt-6 flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 text-xs sm:text-sm text-primary-foreground/80">
