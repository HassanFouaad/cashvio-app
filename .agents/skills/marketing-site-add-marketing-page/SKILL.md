---
name: marketing-site-add-marketing-page
...
*(Note: For industry-specific pages use `marketing-site-add-industry-page`, for interactive calculators/tools use `marketing-site-add-free-tool`, and for user documentation use `marketing-site-add-doc-page`).*
...
6. **Preflight Scan**: Run `node .agents/skills/marketing-site-seo-preflight/scripts/check-content.mjs`.
