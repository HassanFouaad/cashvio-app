---
name: marketing-site-inject-standards
...
- `marketing-site-verify-marketing-code`: 6-step audit & 35-item anti-pattern matrix.
- `marketing-site-seo-preflight`: Pre-ship build & content scan workflow.
- `marketing-site-add-marketing-page`: Scaffold feature landing pages.
- `marketing-site-add-industry-page`: Scaffold industry vertical landing pages.
- `marketing-site-add-free-tool`: Scaffold client-side interactive business tools.
- `marketing-site-add-doc-page`: Add bilingual Fumadocs MDX documentation topics.
- `marketing-site-write-content`: Copywriting standards and retail persona.
- `marketing-site-theme-styling`: Tailwind CSS v4 tokens and receipt primitives.
- `marketing-site-analytics-tracking`: GA4 and Meta Pixel event tracking.
- `marketing-site-app-router-pages`: App Router conventions and metadata.
- `marketing-site-cross-app-sync`: Subdomain cookie sync and preferences.
- `marketing-site-order-export`: Standalone receipt export route.
- `marketing-site-forms-and-api`: Contact forms and backend API client.
- `marketing-site-opengraph-images`: Dynamic edge social cards.
